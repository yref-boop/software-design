...
public class TicketTest {
    ...
    public void test1() {
        ...
        //list.addCriteria(TicketManager.type.price, TicketManager.condition.LessThan, 150);
        //list.addCriteria(TicketManager.connector.AND, TicketManager.type.price, TicketManager.condition.MoreThan, 105);
        //list.addCriteria(TicketManager.type.origin, "Ourense");
        //list.addCriteria(TicketManager.connector.OR, TicketManager.type.origin,"Madrid");

        list.addCriteria(TicketManager.type.destination, "Castilla");
        list.addCriteria(TicketManager.type.origin, "A Coruña");
        list.addCriteria(TicketManager.type.destination, "Castilla");
        list.addCriteria(TicketManager.type.destination, "Castilla");
        list.addCriteria(TicketManager.connector.OR, TicketManager.type.origin, "Madrid");

        //list.addCriteria(TicketManager.connector.AND, TicketManager.type.destination, "A Coruña");
        //list.addCriteria(TicketManager.type.price, TicketManager.condition.MoreThan, 110);
        //list.addCriteria(TicketManager.connector.OR, TicketManager.type.price, TicketManager.condition.LessThan, 100);
